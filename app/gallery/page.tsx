    ...
    <div className="relative min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center min-h-screen px-4 sm:px-6 md:px-8 lg:px-20">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">Gallery</h1>
          <p className="text-sm sm:text-base md:text-lg lg:text-lg text-gray-300">
            Explore our collection of photos and memories from past events.
          </p>
        </div>
      </div>
    </div>

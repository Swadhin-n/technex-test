  ...
  useEffect(() => {
    ...
    const autoRotate = () => {
      if (!draggingRef.current && !focusedElRef.current && !openingRef.current) {
        const nextY = rotationRef.current.y + 0.2;
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen flex relative">
        ...
        {/* Gallery - full width */}
        <div className="flex-1 flex flex-col items-center justify-center pt-0 md:pt-4 px-4 md:px-0">
          <h1 className="text-white text-3xl sm:text-4xl md:hidden font-bold tracking-wide mb-4">
            GALLERY
          </h1>
          <div
            ref={rootRef}
            className="sphere-root relative w-full h-[70vh] sm:h-[75vh] md:h-[80vh] lg:h-[85vh] max-h-[90vh]"
            style={
              {
          ...
          >
            <main
              ref={mainRef}
              className="absolute inset-0 grid place-items-center overflow-hidden select-none bg-transparent h-full"
              style={{
                touchAction: 'none',

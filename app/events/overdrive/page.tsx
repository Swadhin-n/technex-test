...
const EVENT_DATA = {
  title: "Overdrive 8.0", 
  tagline: "Create. Contrive. Conquer", 
  priceRange: "Register via Unstop", 
  venue: "St. Vincent Pallotti College (Offline)",
  duration: "18-19 Dec 2025", 
  poster: "/images/overdrive-bg.jpeg",
  description: "Overdrive 8.0 is the flagship robotics racing event of Technex. It stands where speed meets precision, challenging participants to race through a dynamic arena packed with twists, turns, and obstacles. This year features an upgraded track and a completely revamped competitive experience, blending the adrenaline of racing with the innovation of robotics.", //
  timeline: [
    { title: "Day 1: Qualifier Round", details: "Teams showcase bot speed, stability, and control. Top performers advance based on time and obstacle handling." }, //
    { title: "Day 2: Final Round", details: "Finalists compete on an upgraded, more challenging track. The fastest and most consistent team claims the title." }, //
    { title: "Registration", details: "Registration opens 29 Nov 2025 and closes 18 Dec 2025." } //
  ],
  rules: [
    "Team Size: 1-4 Members.", 
    "Eligibility: Open to all.", 
    "Theme: Robotics & Automation Racing.", 
    "Objective: Navigate obstacles with speed and precision.", 
    "Format: Offline Competition.", 
  ],
  email: "Technex@stvincentngp.edu.in",
  contacts: [
    { name: "Kaushal Bodakhe", role: "Contact Person", phone: "7768859618" },
    { name: "Paridhi Jamkar", role: "Contact Person", phone: "8830966471" },
    ],
  prizes: {
    winner: "₹40,000", 
    runnerUp: "₹25,000", 
    special: "₹10,000 (3rd) + ₹5k Special",
    pool: "₹80,000" 
  }
}
      ...
      <main className="relative z-10 pt-24 pb-12 px-4 md:px-24 flex items-center justify-center min-h-screen">
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {/* Holographic Poster Container - Updated to Cyan/Purple (Cyberpunk/Racing Theme) */}
            <motion.div 
            ...
            >
              <div className="relative rounded-lg overflow-hidden h-[500px] w-full bg-gray-900 border border-cyan-500/30 shadow-[0_0_30px_rgba(34,211,238,0.3)]">
            ...
            >
              <button className="group relative w-full overflow-hidden rounded-md bg-cyan-950 p-4 text-center font-bold uppercase tracking-widest text-cyan-400 border border-cyan-500/50 shadow-[0_0_20px_rgba(34,211,238,0.2)] hover:shadow-[0_0_40px_rgba(34,211,238,0.5)] transition-all">
              ...
              <div className="mt-4 flex justify-between items-center px-2 bg-black/50 p-2 rounded border border-white/10">
                 ...
                 <div className="flex flex-col items-end">
                    <span className="text-sm text-cyan-400 uppercase">Status</span>
          ...
          <div className="lg:col-span-7 flex flex-col h-full">
            ...
            >
              ...
              <h2 className="text-xl md:text-2xl text-purple-400 font-medium mt-2 tracking-wide">
                {EVENT_DATA.tagline}
              </h2>
              <div className="h-1 w-32 bg-gradient-to-r from-purple-600 to-cyan-600 mt-4 rounded-full shadow-[0_0_10px_rgba(168,85,247,0.8)]" />
            </motion.div>
              ...
              <div className="p-6 md:p-8 relative h-full">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                      ...
                      <div className="space-y-6">
                         ...
                         <div className="mt-6 p-4 bg-gradient-to-r from-cyan-900/30 to-purple-900/30 rounded-lg border border-cyan-500/30">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                                <div className="bg-black/40 p-3 rounded border border-purple-500/20">
                                    <div className="text-purple-400 font-bold text-xl">{EVENT_DATA.prizes.winner}</div>
                                ...
                                <div className="bg-black/40 p-3 rounded">
                                    <div className="text-cyan-400 font-bold text-sm leading-tight pt-1">{EVENT_DATA.prizes.special}</div>
                                    <div className="text-xs text-gray-400 uppercase mt-1">Special</div>
                                </div>
                            </div>
                         </div>
                         ...
                         <div className="grid grid-cols-2 gap-4 mt-4">
                            <div className="bg-white/5 p-4 rounded border border-white/10 flex items-center gap-3">
                               ...
                               <div>
                                 <div className="text-cyan-400 text-xs uppercase">Dates</div>
                    ...
                    {activeTab === 'rules' && (
                      <div className="space-y-4">
                         <h3 className="text-2xl font-bold text-white mb-6 border-l-4 border-purple-500 pl-4">Track Protocol</h3>

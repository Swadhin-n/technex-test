...
const EVENT_DATA = {
  ...
  priceRange: "₹350 - ₹450", 
  venue: "St. Vincent Pallotti College of Eng. & Tech.",
  duration: "18-19 Dec (Overnight)", 
  poster: "/images/envision-bg.jpeg", 
  description: "ENVISION'26 is a hands-on Datathon challenging participants to work with real-world data to build meaningful, end-to-end solutions. Teams will collect their own datasets, explore and preprocess information, create insightful visualizations, and apply machine learning or analytical techniques to solve practical business problems. It blends data analysis, problem-solving, storytelling, and innovation.",
  timeline: [
    { title: "Round 1: Data Collection & Roadmap", details: "Define problem statement, collect real-world datasets, and present initial workflow poster." },
    { title: "Round 2: Data Preprocessing & Visualization", details: "Clean dataset and create 5 meaningful visualizations using BI tools or Python." },
    { title: "Round 3: Model Building & BI Analysis", details: "(Overnight) Build ML models and develop BI dashboards showing business insights." },
    { title: "Final Round: Presentation", details: "Present complete solution pipeline to judges: dataset, models, dashboard, and recommendations." }
  ],
  rules: [
    "Team Size: 2-4 members (UG students & recent graduates).",
    "No Kaggle datasets allowed. Data must be open-source or self-scraped.",
    "Mandatory: Both ML Model and BI Dashboard must be developed.",
    "Allowed Tools: Python, R, Power BI, Tableau, Google Colab, etc.",
    "Plagiarism of code, report, or dashboard leads to direct disqualification.",
  ],
  email: "technex@stvincentngp.edu.in",
  contacts: [
    { name: "Shrenik Nil", role: "Organizer", phone: "+91 9766915324" },
    { name: "Priyanshi Khadgi", role: "Organizer", phone: "+91 95791 08633" },
  ],
  prizes: {
    winner: "₹25,000",
    runnerUp: "₹15,000",
    special: "₹5,000 (Best Visuals / Best BI Model)"
  }
}

// --- NEW FAQ DATA ---
const FAQS = [
  { question: "What is the team size limit?", answer: "Teams of 2-3 members only." },
  { question: "Can we use Kaggle datasets?", answer: "No, datasets must be open-source or self-scraped. Kaggle datasets are not allowed." },
  { question: "What tools are allowed?", answer: "Python, R, Power BI, Tableau, Google Colab, and other standard data science tools." },
  { question: "Is both ML model and BI dashboard mandatory?", answer: "Yes, both ML model development and BI dashboard creation are mandatory." },
  { question: "What happens if we plagiarize code?", answer: "Plagiarism of code, reports, or dashboards leads to immediate disqualification." }
];
        ...
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <motion.div 
              ...
              className="relative group rounded-xl p-1 bg-gradient-to-br from-cyan-500 via-purple-600 to-cyan-500"
            >
              <div className="relative rounded-lg overflow-hidden h-[500px] w-full bg-gray-900 border border-cyan-500/30 shadow-[0_0_30px_rgba(6,182,212,0.3)]">
                ...
                <div className="absolute top-4 right-4 z-20 bg-black/70 backdrop-blur border border-cyan-400 px-3 py-1 rounded text-cyan-400 font-mono text-xs">
                  DATATHON
                </div>
                ...
                <div className="relative w-full h-full">
                   <Image 
                    ...
                    alt="ENVISION Brain Data funnel" 
                    fill 
            ...
            >
              ...
              <div className="mt-4 flex justify-between items-center px-2 bg-black/50 p-2 rounded border border-white/10">
                 ...
                 <div className="flex flex-col items-end">
                    <span className="text-sm text-cyan-400 uppercase">Registration Fee</span>
          ...
          <div className="lg:col-span-7 flex flex-col h-full">
            ...
            <motion.div 
              ...
              className="mb-8"
            >
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-cyan-200 to-cyan-500 uppercase drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">
                {EVENT_DATA.title}
              </h1>
              <h2 className="text-xl md:text-2xl text-purple-300 font-medium mt-2 tracking-wide">
                {EVENT_DATA.tagline}
              </h2>
              <div className="h-1 w-32 bg-gradient-to-r from-purple-600 to-cyan-600 mt-4 rounded-full shadow-[0_0_10px_rgba(147,51,234,0.8)]" />
            </motion.div>
            ...
            <div className="relative flex-1 min-h-[500px] bg-gray-900/60 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-2xl mb-8">
              ...
              <div className="p-6 md:p-8 relative h-full">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    {/* ... (Previous Tab Contents: About, Timeline, Rules, Contact) - Kept same as provided code ... */}
                    {activeTab === 'about' && (
                      <div className="space-y-6">
                         <h3 className="text-2xl font-bold text-white mb-4 border-l-4 border-cyan-500 pl-4">Event Briefing</h3>
                         ...
                         <div className="mt-6 p-4 bg-gradient-to-r from-purple-900/30 to-cyan-900/30 rounded-lg border border-purple-500/30">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                                <div className="bg-black/40 p-3 rounded">
                                    <div className="text-yellow-400 font-bold text-xl">{EVENT_DATA.prizes.winner}</div>
                                    <div className="text-xs text-gray-400 uppercase">Winner</div>
                                </div>
                                <div className="bg-black/40 p-3 rounded">
                                ...
                                <div className="bg-black/40 p-3 rounded">
                                    <div className="text-cyan-400 font-bold text-lg">{EVENT_DATA.prizes.special}</div>
                                    <div className="text-xs text-gray-400 uppercase">Special Awards</div>
                                </div>
                            </div>
                         </div>
                      </div>
                    ...
                    {activeTab === 'timeline' && (
                      <div className="space-y-4">
                         <h3 className="text-2xl font-bold text-white mb-6 border-l-4 border-cyan-500 pl-4">Event Rounds</h3>
                    ...
                    {activeTab === 'rules' && (
                      <div className="space-y-4">
                         <h3 className="text-2xl font-bold text-white mb-6 border-l-4 border-purple-500 pl-4">Protocols</h3>
                    ...
                    {activeTab === 'contact' && (
                      <div className="space-y-6">
                        ...
                        <a href={`mailto:${EVENT_DATA.email}`} className="block bg-gradient-to-r from-cyan-900/40 to-purple-900/40 p-4 rounded-xl border border-cyan-500/30 hover:border-cyan-400 transition-all group mb-6">
            ...
            {/* ============================================== */}
            {/* NEW FAQ SECTION (Expandable Cards) */}
            {/* ============================================== */}
              ...
              <div className="flex flex-col gap-3">
                 {FAQS.map((faq, index) => {
                   ...
                   return (
                     <motion.div
                       key={index}
                       layout // The magic prop for smooth shifting

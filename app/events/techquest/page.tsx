...
const EVENT_DATA = {
  title: "TECHQUEST 2k26",
  tagline: "Decode. Discover. Dominate.",
  priceRange: "₹50 Per Participant",
  venue: "St. Vincent Pallotti College (Offline)",
  duration: "18-19 Dec 2025",
  poster: "/images/techquest-bg.jpeg", // Placeholder
  description: "TECHQUEST 2k26 is an immersive QR-based digital coding treasure hunt. It blends fast-paced coding challenges, logical puzzles, and technical quizzes into a competitive race. Teams must scan QR codes scattered across the venue to unlock time-bound problems, solve them within minutes, and race to the next stage to uncover the final mystery.",
  timeline: [
    { title: "Round 1: QR Coding Hunt", details: "Teams scan hidden QR codes to unlock and solve 5-minute coding challenges to progress." },
    { title: "Round 2: Common Clue", details: "Surviving teams converge at a common stage to solve a complex logical output puzzle." },
    { title: "Round 3: Grand Tech Quiz", details: "The final showdown testing technical understanding and memory based on hints collected during the hunt." }
  ],
  rules: [
    "Team Size: 2-5 Members.",
    "Tools: Mobile QR Scanner & Laptop required.",
    "Sequence: Teams must not skip QR stages.",
    "Originality: Plagiarism leads to immediate disqualification.",
    "Eligibility: Open to all Engineering & Management students.",
  ],
  email: "Technex@stvincentngp.edu.in",
  contacts: [
    { name: "Vedant Ghatole", role: "Contact Person", phone: "7057422325" },
  ],
  prizes: {
    pool: "₹40,000",
    first: "₹15,000",
    second: "₹10,000",
    special: "₹5,000 (3rd) + Special Awards"
  }
}
...
export default function EventDetailsPage() {
  ...
  const tabs = [
    ...
    { id: 'timeline', label: 'Stages', icon: Map }, 
      ...
      <main className="relative z-10 pt-24 pb-12 px-4 md:px-24 flex items-center justify-center min-h-screen">
        <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {/* Holographic Poster Container - Green & Black (Matrix/Code Theme) */}
            <motion.div 
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
              className="relative group rounded-xl p-1 bg-gradient-to-br from-green-600 via-emerald-900 to-green-600"
            >
              <div className="relative rounded-lg overflow-hidden h-[500px] w-full bg-gray-900 border border-green-500/30 shadow-[0_0_30px_rgba(34,197,94,0.3)]">
                ...
                <div className="absolute top-4 right-4 z-20 bg-black/70 backdrop-blur border border-green-500 px-3 py-1 rounded text-green-500 font-mono text-xs flex items-center gap-2">
                  <QrCode size={12} /> DIGITAL HUNT
                </div>
            ...
            >
              <button className="group relative w-full overflow-hidden rounded-md bg-green-950 p-4 text-center font-bold uppercase tracking-widest text-green-500 border border-green-500/50 shadow-[0_0_20px_rgba(34,197,94,0.2)] hover:shadow-[0_0_40px_rgba(34,197,94,0.5)] transition-all">
                ...
                <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-green-700 to-emerald-800 transition-transform duration-300 group-hover:translate-x-0" />
              </button>
              ...
              <div className="mt-4 flex justify-between items-center px-2 bg-black/50 p-2 rounded border border-white/10">
                 ...
                 <div className="flex flex-col items-end">
                    <span className="text-sm text-green-500 uppercase">Registration</span>
          ...
          <div className="lg:col-span-7 flex flex-col h-full">
            ...
            <motion.div 
              ...
              className="mb-8"
            >
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-white via-green-200 to-green-600 uppercase drop-shadow-[0_0_10px_rgba(34,197,94,0.5)]">
                {EVENT_DATA.title}
              </h1>
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-green-600 to-emerald-600"
                          transition={{ type: "spring", stiffness: 300, damping: 30 }}
                        >
                           <div className="absolute -top-4 left-1/2 -translate-x-1/2 text-green-500 drop-shadow-[0_0_8px_rgba(34,197,94,1)]">
                             <ScanLine size={16} className="fill-current" />
                           </div>
                        </motion.div>
                      )}
                    </button>
                  ...
                  >
                    ...
                    {activeTab === 'about' && (
                      <div className="space-y-6">
                         <h3 className="text-2xl font-bold text-white mb-4 border-l-4 border-green-500 pl-4">Quest Overview</h3>
                         ...
                         <div className="mt-6 p-4 bg-gradient-to-r from-green-900/30 to-emerald-900/30 rounded-lg border border-green-500/30">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                                <div className="bg-black/40 p-3 rounded border border-green-500/20">
                                    <div className="text-green-500 font-bold text-xl">{EVENT_DATA.prizes.first}</div>
                                ...
                                <div className="bg-black/40 p-3 rounded">
                                    ...
                                    <div className="text-xs text-gray-400 uppercase mt-1">3rd + Special</div>
                                </div>
                            </div>
                         </div>
                         ...
                         <div className="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div className="bg-white/5 p-4 rounded border border-white/10 flex items-start gap-3">
                               ...
                               <div>
                                  <div className="text-emerald-400 text-xs uppercase">Venue</div>
                    ...
                    {activeTab === 'timeline' && (
                      <div className="space-y-4">
                         <h3 className="text-2xl font-bold text-white mb-6 border-l-4 border-green-500 pl-4">Hunt Roadmap</h3>
                         <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-green-500 before:to-transparent">
                           {EVENT_DATA.timeline.map((item, idx) => (
                             <div key={idx} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                               <div className="flex items-center justify-center w-10 h-10 rounded-full border border-green-500 bg-green-950 group-[.is-active]:bg-green-500 text-green-500 group-[.is-active]:text-white shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10">
                                 <QrCode size={18} />
                               </div>
                    ...
                    {activeTab === 'rules' && (
                      <div className="space-y-4">
                         <h3 className="text-2xl font-bold text-white mb-6 border-l-4 border-emerald-500 pl-4">Access Protocol</h3>
                         ...
                         <div className="grid grid-cols-2 gap-2 mt-4">
                            <div className="bg-green-900/20 border border-green-500/30 p-3 rounded flex items-center gap-2">
                                <Terminal className="text-green-500" size={20} />
                                <span className="text-xs text-green-200">Coding Required</span>
                            </div>
                            <div className="bg-emerald-900/20 border border-emerald-500/30 p-3 rounded flex items-center gap-2">
                                <Cpu className="text-emerald-400" size={20} />
                                <span className="text-xs text-emerald-300">Logic Puzzles</span>
                            </div>
                         </div>
                      </div>
                    )}
                    ...
                    {activeTab === 'contact' && (
                      <div className="space-y-6">
                        <h3 className="text-2xl font-bold text-white mb-6 border-l-4 border-green-500 pl-4">System Admin</h3>
                        
                        {/* Email Link */}
                        <a href={`mailto:${EVENT_DATA.email}`} className="block bg-gradient-to-r from-green-900/40 to-emerald-900/40 p-4 rounded-xl border border-green-500/30 hover:border-green-400 transition-all group mb-6">
